...
def btn_click():
    ...
    im.save("pic.png")
    imagepath = 'pic.png'
    load = Image.open('pic.png')  # 我图片放桌面上
...
d = Button(station_frame, text='关键字手动搜索', command=btn_find)
d['width'] = 18
d['height'] = 2
d.pack(side='left')
ipText.bind("<Return>", btn_click_enter)
...
text = Text(text_frame, width=45, height=16, font=('宋体', 16))
text.pack()
main_frame.pack()
